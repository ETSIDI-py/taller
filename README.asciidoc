...
[cols=",",options="header",]
|===
|Plataforma (para las lecciones)|Pizarra (para compartir texto y código)
...
https://github.com/[GitHub] o cualquier otro en el que te sientas cómod@.
. Instalar un cliente git, p. ej. https://desktop.github.com/[GitHub Desktop] o cualquier otro en el que te sientas cómod@.
. Instalar un entorno Python mediante https://github.com/isi-ies-group/python-info#miniconda[miniconda] o cualquier otro en el que te sientas cómod@.
. Instalar algún IDE, p. ej. https://github.com/isi-ies-group/python-info#ide---spyder[Spyder] o cualquier otro en el que te sientas cómod@.
