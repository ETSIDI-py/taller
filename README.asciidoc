...
|===
|Plataforma (intro y tutorial) |Pizarra (compartir texto y código) |Chuletas

|https://colab.research.google.com/github/ETSIDI-py/taller/blob/main/intro.ipynb[Jupyter en Google Colab] o https://mybinder.org/v2/gh/ETSIDI-py/taller/HEAD?labpath=intro.ipynb[Jupyter en Binder]
